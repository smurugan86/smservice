...
public final class RestConstants {
	...
	public static final String PRICE_CATALOG_DOC_TYPE = "832";
	...
	public static final String LOCATION_SHOULD_NOT_EMPTY = "Location should not be empty";
	public static final String ERROR_IN_VALIDATEPAYLOAD = "Error in validatePayload";
	public static final String ERROR_IN_SAVEJOBRECORD = "Error in saveJobRecord";	
	public static final String ERROR_IN_GETJOBRECORD = "Error in getJobRecord";
